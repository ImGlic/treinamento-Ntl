...
<script src="<?php echo ASSETS_URL; ?>/js/business_Dependentes.js" type="text/javascript"></script>
...
<script language="JavaScript" type="text/javascript">
    $(document).ready(function() {
        ...
        $("#descricao").on("change", function() {
            var dependente = $("#descricao").val()          
         
            if (dependente == "") {
                smartAlert("Atenção", "Tipo de Dependentes inválido, não será possivel cadastrar", "error");
                $("#descricao").val('');
            }
    ...
    function verificarDependentes() {
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data == 'failed#') {
                    smartAlert("Atenção", "Tipo de Dependente já Cadastrado!", "error");                    
                    $("#descricao").val("");                                       
                }else{
                    gravar();
                }
    ...
    function novo() {
        $(location).attr('href', 'dependentesCadastro.php');
    }

    function voltar() {
        $(location).attr('href', 'dependentesFiltro.php');
    }
    ...
    function gravar() {
        ...
        gravaDependentes(codigo, ativo, dependente,
            function(data) {
