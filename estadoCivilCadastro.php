                                                    ...
                                                    <fieldset>
                                                        <div class="row">
                                                            ...
                                                            <section class="col col-5 col-auto">
                                                                <label class="label" for="descricao">Estado Civil</label>
                                                                <label class="input">
...
<script language="JavaScript" type="text/javascript">
    $(document).ready(function() {
        ...
        $("#descricao").on("change", function() {
                estadoCivil = $("#descricao").val()

            if (estadoCivil == "") {
                smartAlert("Atenção", "Estado Civil inválido, não será possivel cadastrar", "error");
                $("#descricao").val('');
            }
        });
    ...
    function gravar() {
        ...
        if (!descricao) {
            smartAlert("Atenção", "Informe um Estado Civil", "error");
            $("#btnGravar").prop('disabled', true);
            return;
        }
        ...
        gravaEstadoCivil(codigo, ativo, descricao,
            function(data) {
