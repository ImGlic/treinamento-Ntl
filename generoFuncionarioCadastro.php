...
<script language="JavaScript" type="text/javascript">
    $(document).ready(function() {
        ...
        $("#descricao").on("change", function() {                     
            ...
            if (genero == "") {
                smartAlert("Atenção", "Gênero inválido, não será possivel cadastrar", "error");
                $("#descricao").val('');
            } 
        });
    ...
    function verificarGenero() {
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data == 'failed#') {
                    smartAlert("Atenção", "Genero já Cadastrado!", "error");
                    $("#descricao").val(''); 
                }else{
                    gravar();
                }
    ...
    function novo() {
        $(location).attr('href', 'generoFuncionarioCadastro.php');
    }

    function voltar() {
        $(location).attr('href', 'generoFuncionarioFiltro.php');
    }
    ...
    function gravar() {
        ...
        if (!descricao) {   
            smartAlert("Atenção", "Informe um gênero", "error");
            $("#btnGravar").prop('disabled', true);
            return;
        }
        ...
        gravaGeneroFuncionario(codigo, ativo, descricao, 
            function(data) {
